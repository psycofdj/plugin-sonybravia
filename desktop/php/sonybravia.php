        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="psk" disabled="disabled" placeholder="{{PIN associé au nom d'équipement}}"/>
              </div>
              <div class="col-sm-2">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8"><br/>
                <ol>
                  <li>Activer l'accès distant sur votre TV : [Paramètres] => [Réseaux] => [Configuration Réseau domestique] => [Contrôle IP] => [On]</li>
                  <li>Activer l'accès par clé partagée : [Paramètres] => [Réseaux] => [Configuration Réseau domestique] => [Contrôle IP] => [Authentification] => [Normal et clé pré-partagée]</li>
                  <li>
                    Lancer la procédure d'appairement de l'équipement en appuyant sur le bouton ci-dessous. Le PIN s'affichera sur le téléviseur.<br/>
                    <a class="btn btn-primary eqLogicAction show_pin">
